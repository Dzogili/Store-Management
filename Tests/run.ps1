...
# python main.py --help
# python main.py --type authentication --authentication-url http://localhost:5000 --jwt-secret JWT_SECRET_KEY --roles-field roles --owner-role owner --customer-role customer --courier-role courier
#python main.py --type level0 --with-authentication --authentication-url http://localhost:5000 --owner-url http://127.0.0.1:5001 --customer-url http://127.0.0.1:5002
